...
import com.pro.manga.exception.StorageException;
import com.pro.manga.exception.StorageFileNotFoundException;
...
public class FileSystemStorageServiceImpl implements StorageService{
	...
	@Override
	public String getStoredString(MultipartFile file, String id) {
	...
	@Override
	public Resource loadsResource(String filename) {
		try {
